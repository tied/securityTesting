        ...
        <div id="full-height-container">
                    ...
                    <td style=" width: 49%;vertical-align: initial;">
                        ...
                        <fieldset class="compact-form-fields">
                            <!--<div class="field-group">
                                <label class="custom-login-label" for="conf-username">Username:</label>
                                <input type="text" id="conf-username" name="conf-username" value=""
                                       placeholder="Username" class="text"/>
                            </div>
                            <br/>
                            <div class="field-group">
                                <label class="custom-login-label"  for="conf-password">Password:</label>
                                <input type="password" id="conf-password" name="conf-password" value=""
                                       placeholder="Password" class="text"/>
                            </div>
                            <br/>-->
                            <div class="field-group">
            ...
            <td style="width: 49%;vertical-align: initial;">
                <div id="custom-sso-login" style="border-radius: 5px;padding: 20px;border: 1px solid lightgrey;">
                    ...
                    <br/> &nbsp;&nbsp;
                    <div class="field-group">
                        <input type="button" class="aui-button aui-button-primary" value="Use IDP Login" onclick="AuthUrl()"/>
                    </div>
                </div>
            </td>
            </tr>
