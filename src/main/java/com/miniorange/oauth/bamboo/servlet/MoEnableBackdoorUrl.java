...
public class MoEnableBackdoorUrl extends HttpServlet {
    ...
    public MoEnableBackdoorUrl(MoOAuthSettings settings, BambooUserManager bambooUserManager, BambooPermissionManager bambooPermissionManager) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (BooleanUtils.toBoolean(isAdmin)) {
            ...
            if (BooleanUtils.toBoolean(settings.getDefaultLoginDisabled())) {
                ...
                LOGGER.error("Unable to Enable Backdoor URL because Auto redirect to IDP is disabled.");
                showErrorMessage(response, "Unable to Enable Backdoor URL because Auto redirect to IDP is disabled.");
            }
        } else {
